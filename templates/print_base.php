...
<body>
    ...
    <header>
        <nav class="menu bg-white py-2 border-bottom no_print no_print">
            ...
            <form action="../exportar/exportexcelrecebidospagos.php" method="POST">
                <div class="d-grid d-flex gap-2">
                    ...
                    <span tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="Exportar para Excel">
                        <button type="submit" class="btn btn-sm btn-outline-primary center-block"><i class="bi bi-filetype-xlsx"></i></button>
                    </span>
                    <button type="button" class="btn btn-close" onclick="window.location.href='../cadastros/arrecadacoes'"></button>
    ...
    <script>
        function listarRecebidosPagos() {
            ...
            $.ajax({
                url: '../consultas/printcebidospagos.php',
                type: 'POST',
                data: {
        ...
        function excelRecebidosPagos() {

            const dataAtual = document.getElementById("data_fim").value;
            const dataInicio = document.getElementById("data_ini").value;

            $.ajax({
                url: '../exportar/exportexcelrecebidospagos.php',
                type: 'POST',
                data: {
                    data_inicio: dataInicio,
                    data_final: dataAtual
