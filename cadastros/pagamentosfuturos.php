...
<body>
        ...
        <div class="container-fluid mt-1">
            <div class="col-sm-9 mx-auto px-3 border border-secondary bg-light shadow rounded-3 align-self-center">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active">A Pagar</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <form class="row mb-3 px-3 gap-3" name="meu-form" action="../edits/alteraconfig.php" method="POST">
                        <div class="row d-grid gap-1 d-flex justify-content-between">
                            ...
                            <div class="d-flex gap-1 col-md-3 offset-md-3">
                                ...
                                <input type="hidden" name="tela" value="a_pagar">
                ...
                $result_financeiro = "SELECT * FROM financeiro WHERE id_empresa = '$id' AND tipo = 'D' ORDER BY datavenc_at DESC LIMIT $inicio, $qtd_result_pg";
                ...
                if ($row_financeiro != 0) : ?>
                            ...
                            <tbody id="myTable">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <span tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="Marcar Pago">
                                                <button type="button" class="btn btn-sm btn-outline-success" id="botao_editar<?php echo $row_financeiro['id']; ?>" onclick="pagar_registro(<?php echo $row_financeiro['id']; ?>)" data-bs-toggle="modal" data-bs-target="#modal_pay" data-bs-trigger="hover focus" data-bs-content="Marcar Pago"><i class="fa-regular fa-money-bill-1"></i></button>
                                                <!--button type="button" class="btn btn-sm btn-outline-primary center-block" id="botao_salvar" style="display: none;"><i class="fa fa-floppy-disk"></i></button-->
                                            </span>
                                        </td>
                                        <td>
                    ...
                    <div class="col-sm-12 mx-auto bg-white text-center px-2 mb-3 pb-2 align-self-center">
                        ...
                        $result_pg = "SELECT COUNT(id) AS num_result FROM financeiro WHERE id_empresa = '$id' AND tipo = 'D'";
                        ...
                        <?php if ($row_pg['num_result'] > $qtd_result_pg) {
                            ...
                            $max_links = 2;
                            echo "<a class='btn btn-sm btn-outline-primary mx-1' href='pagamentosfuturos?pagina=1'><i class='fas fa-angle-left'></i></a>";
                            for ($pag_ant = $pagina - $max_links; $pag_ant <= $pagina - 1; $pag_ant++) {
                                if ($pag_ant >= 1) {
                                    echo "<a class='btn btn-sm btn-outline-primary mx-1' href='pagamentosfuturos?pagina=$pag_ant' disabled>$pag_ant</a>";
                                }
                            }
                            echo "<button type='button' class='btn btn-sm btn-outline-primary mx-1' disabled>$pagina</button>";
                            for ($pag_dep = $pagina + 1; $pag_dep <= $pagina + $max_links; $pag_dep++) {
                                if ($pag_dep <= $quantidade_pg) {
                                    echo "<a class='btn btn-sm btn-outline-primary mx-1' href='pagamentosfuturos?pagina=$pag_dep'>$pag_dep</a>";
                                }
                            }
                            echo "<a class='btn btn-sm btn-outline-primary mx-1' href='pagamentosfuturos?pagina=$quantidade_pg'><i class='fas fa-angle-right'></i></a>";
                        }
                        //$conexao->close();
                        ?>
    ...
    <div class="modal fade" id="modal_pay">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <p class="modal-title fs-5 fw-light">Marcar como Pago</p>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <p class="fs-5 text-secondary fw-light mx-5">Confirma o Lançamento como Pago?</p>
