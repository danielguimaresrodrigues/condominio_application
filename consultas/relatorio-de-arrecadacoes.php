...
include '../templates/print_base.php';
?>

<section class="vw-100 mx-auto">
    <div class="container-fluid px-5 py-1" id="fundo">
        <div class="mx-auto bg-white border border-top-0 border-start-0 border-end-0 border-secondary py-2 align-self-center d-flex">
            <div><img class="img-fluid" src="../assets/img/Symbol-gestorr-horizontal.svg" style="width: 10vw; height: auto;"></div>
            <p class="nome_cond text-center"><span style="font-weight: bold;"><?php echo $row_empresa['nome']; ?></span> | <?php echo $row_empresa['email']; ?> </p>
        ...
        <div class="table_rp mx-auto">
            <div class="mx-auto bg-white border border-top-0 border-start-0 border-end-0 border-secondary py-1">
                <p class="text-center mx-auto"><span style="font-weight: bold;">Relatório de Recebidos e Pagos</span></p>
